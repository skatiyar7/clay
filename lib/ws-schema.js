...
var schema = {
  ...
  "list_live_cli_sessions":   { direction: "c2s", handler: "lib/project-live-sessions.js", description: "Request live (currently running) terminal CLI sessions" },
  "live_mirror_detach":       { direction: "c2s", handler: "lib/project-live-sessions.js", description: "Stop live-mirroring a terminal CLI session" },
  ...
  "live_cli_sessions":        { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "List of terminal CLI sessions running live on the host" },
  "live_mirror_state":        { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Live-mirror attached/detached state for a session" },
