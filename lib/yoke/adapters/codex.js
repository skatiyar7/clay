...
function createCodexQueryHandle(appServer, queryOpts) {
  ...
  var state = {
    ...
    aborted: false,
    loopStarted: false,
    model: queryOpts.model || "openai.gpt-5.4",
  ...
  var adapter = {
    ...
    init: function(initOpts) {
      ...
      _initPromise = (async function() {
        ...
        console.log("[codex] App-server initialized, models: openai.gpt-5.4, gpt-5.4, gpt-5.4-mini, gpt-5.3-codex, gpt-5.3-codex-spark, gpt-5.2");
    ...
    createQuery: async function(queryOpts) {
      ...
      var model = queryOpts.model || "openai.gpt-5.4";
